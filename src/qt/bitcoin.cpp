...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. ApeCoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    {
        if (boost::algorithm::istarts_with(argv[i], "apecoin:"))
        {
    ...
    app.setOrganizationName("ApeCoin");
    app.setOrganizationDomain("we-have-no-domain-yet.nex");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("apecoin-qt-testnet");
    else
        app.setApplicationName("apecoin-qt");
