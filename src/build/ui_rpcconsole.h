...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "ApeCoin - Debug window", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the ApeCoin debug logfile from the current data directory. This can take a few seconds for large logfiles.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the apecoin-qt help message to get a list with possible command-line options.", 0));
#endif // QT_NO_TOOLTIP
